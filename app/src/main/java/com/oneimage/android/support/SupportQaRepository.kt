...
val starterAnswers = listOf(
    ...
    qa("privacy-policy", "Privacy", 502, "Does GenStudio sell personal information?", "The in-app privacy summary says personal information is not sold to third parties.", "The Privacy & Terms screen says GenStudio uses data to provide image, video, and asset generation features and does not sell personal information to third parties.", "privacy policy", "personal information"),

...
val starterAnswers = listOf(
    ...
    qa("account-plan-status", "Account", 202, "What plan information is shown in the app?", "Settings shows the current role, plan, status, and credits from your shared account.", "The Android app reads your existing account role, plan, status, and credits from the shared GenStudio profile. It does not manage purchases locally. If your access changes on the web, the updated account state should appear here after sync.", "plan", "status", "credits", "account"),
    ...
    qa("account-rewarded-ads", "Account", 204, "How do I earn credits on Android?", "Open Earn Credits and watch a rewarded ad to the end.", "Android accounts receive a small starter balance that is below the cost of a generation. To increase it, open Earn Credits from the dashboard or Settings and watch a rewarded ad to the end. Credits are added after server verification and appear in your shared account balance.", "credits", "rewarded ads", "earn credits", "android"),

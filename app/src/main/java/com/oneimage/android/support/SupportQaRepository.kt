...
val starterAnswers = listOf(
    ...
    qa("account-service-model", "Account", 201, "Why does the app use credits?", "Generation uses metered compute, storage, and service maintenance.", "GenStudio is an independent creative service. Image, video, and 3D generation consume metered resources, so credits are required to run tasks. Android reads the same shared account access and credit balance that your web workspace uses.", "credits", "service model", "compute"),
    qa("account-plan-status", "Account", 202, "What plan information is shown in the app?", "Settings shows the current role, plan, status, and credits from your shared account.", "The Android app reads your existing account role, plan, status, and credits from the shared GenStudio profile. Android credit packs are sold through Google Play; web plans and Stripe top-ups remain on the web. If your access changes on either side, the updated account state should appear here after sync.", "plan", "status", "credits", "account", "google play", "purchase"),
    ...
    qa("account-rewarded-ads", "Account", 204, "How do I get credits on Android?", "Open Credits to buy a Google Play pack or watch a rewarded ad.", "New Android accounts can start with 0 credits because generation is a paid service. Open Credits from the dashboard or Settings, then buy a Google Play credit pack or watch a rewarded ad to the end. Credits are added after server verification and appear in your shared account balance.", "credits", "rewarded ads", "earn credits", "android", "google play", "buy"),
    ...
    qa("workflow-ref-restyle", "Workflows", 312, "What does Ref Restyle need?", "It needs a source image, a style reference image, and a prompt.", "Use Ref Restyle when you want one image recreated with the style, color, material, or lighting of another image. Upload the source image first, add the reference image second, then describe what should transfer from the reference.", "ref restyle", "reference image", "style", "image edit"),
    qa("workflow-character-replacement", "Workflows", 306, "What files does Character Replacement need?", "It needs a source video up to 3 seconds and a character reference image.", "Character Replacement changes a character in a short clip while preserving motion, pose, timing, and scene. Use a source video that is 3 seconds or shorter and a clear reference image of the replacement identity or character.", "character replacement", "video", "reference image", "3 seconds"),
    ...
    qa("privacy-policy", "Privacy", 502, "Does GenStudio sell personal information?", "The shared GenStudio Privacy Policy says personal information is not sold.", "GenStudio uses the same hosted Privacy Policy on web and Android. Open Privacy & Terms to read the full policy, including data use, retention, deletion, and sale/sharing statements.", "privacy policy", "personal information"),
    qa("terms-content-rules", "Privacy", 503, "What content is not allowed?", "The shared GenStudio Terms of Service control AI acceptable-use rules.", "GenStudio uses the same hosted Terms of Service on web and Android. Open Privacy & Terms to read the full AI acceptable-use, payment, content responsibility, and account enforcement rules.", "terms", "illegal", "harmful", "acceptable use"),
